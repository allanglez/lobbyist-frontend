...
class ExternalEntityTypeForm extends EntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $theme_enable = $form_state->getValue(['theme', 'theme_enable']);
    if ($theme_enable === NULL) {
      $theme_enable = $external_entity_type->isThemeable();
    }
    $form['theme']['themeable'] = [
      '#type' => 'checkbox',
      '#title' => $this->t('Enable theming on this external entity type'),
      '#description' => $this->t('Enable theming to render the entities with template in active theme'),
      '#default_value' => $theme_enable,
    ];
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    ...
    $form_state->setValue('themeable', $form_state->getValue([
      'theme',
      'themeable',
    ]));
  }
