  ...
  class InHouseLobbyist extends BlockBase implements BlockPluginInterface{
    ...
    */
    public function build(){
      ...
      $content[] = array(
        '#type' => 'markup',
        '#markup' => '<a type="button" href="/in-house-account-home/add_an_in_house_lobbyust_to_your" class="btn btn-primary purple-button">'.t(\Drupal::config('biz_lobbyist_registration.settings')->get('add_an_in_house_lobbyust_button_text')).'</a>',
      );
      return $content;
    }
